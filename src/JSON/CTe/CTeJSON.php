...
class InfDoc {
	public IList<InfNF> infNF; //String
	public IList<InfNFe> infNFe; //String
	public IList<InfOutro> infOutros; //String
}
...
class InfCte
{
	...
	public Ide ide; //String
	public Compl compl; //String
	public Emit emit; //String
	public Rem rem; //String
	public Exped exped; //String
	public Receb receb; //String
	public Dest dest; //String
	public VPrest vPrest; //String
	public Imp imp; //String
	public InfCTeNorm infCTeNorm; //String
	public InfCteComp infCteComp; //String
	public InfCteAnu infCteAnu; //String
	public IList<AutXML> autXML; //String
}

class CTe
{
	public InfCte infCte; //String
}
...
class Peri
{
	...
	public InfTotAP infTotAP; //String
}
...
class Aereo
{
	...
	public NatCarga natCarga; //String
	public Tarifa tarifa; //String
	public IList<Peri> peri; //String
}
...
{
	public $nCont; //String
	public IList<Lacre> lacre; //String
	public InfDoc infDoc; //String
}
...
class Aquav
{
	...
	public IList<Balsa> balsa; //String
	public $nViag; //String
	public $direc; //String
	public $irin; //String
	public IList<DetCont> detCont; //String
}
...
class FerroEnv
{
	...
	public $IE; //String
	public $xNome; //String
	public EnderFerro enderFerro; //String
}
...
class TrafMut
{
	...
	public IList<FerroEnv> ferroEnv; //String
}

class Ferrov
{
	public $tpTraf; //String
	public TrafMut trafMut; //String
	public $fluxo; //String
}
